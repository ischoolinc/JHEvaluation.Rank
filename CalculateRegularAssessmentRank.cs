...
ORDER BY
    ...
    ";
        ...
        , '" + settingEle.OuterXml.Replace("'", "''") + @"'::TEXT AS calculation_setting";
                        ...
                        #region 1. 計算排名的SQL (原本) + 2021-09-22 嶸峰 缺/免 處理
                        ...
                        #region 1. 計算排名的SQL (原本) + 2021-09-22 嶸峰 缺/免 處理 + 2021-12 Cynthia 新五標 + 標準差
                        // 2021-11 增加計算 新五標及標準差
                        // 20191118 根據高中 commit "清理程式碼" > 精簡程式碼
                        string insertRankSql = @"
WITH row AS (
" + string.Join(@"
...
//                        //";
                        ...
                        #region 2. 計算排名的SQL (增加 單純定期(實際考試) 的排名)+ 2021-09-22 嶸峰 缺/免 處理
